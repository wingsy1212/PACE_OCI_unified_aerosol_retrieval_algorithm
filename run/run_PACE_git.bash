...
echo $input_dir
input_dir=/tis/atmosphere/scratch/Dark_Target/smattoo/Projects_from_data4/PACE_Git_August2024/Input_L1 
OUT_dir=/tis/atmosphere/scratch/Dark_Target/smattoo/Projects_from_data4/PACE_Git_August2024/Output
echo $input_dir 
...
#          obsfile=$(find "${path_obs}" -name "PACE_OCI.${year}${month}${day}T${hh}${mm}*.L1B.nc" ) 
...
########################################################################
    ...
    echo $obsfile $Anc1,$Anc2, PACE_output.nc Interm_file.nc    
