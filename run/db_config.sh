...
while getopts ":y:m:d:t:g:c:o:i:p:s:" OPTION
do
  	case $OPTION in
  		y	)	opt_year=${OPTARG};;
#   		m	)	opt_month=${OPTARG};;
...
#   -- increment the date by 1 day to pick up the correct 0z model data.
  ...
  *)
  ...
  pre_anc_dir=${geos_dir}"${year}/${geo_doy0}/"
  post_anc_dir=${geos_dir}"${post_year}/${geo_doy1}/"
...
#   post_anc_file=`find -L ${l1a_dir} -maxdepth 1 -name "${post_anc_base}"`
  ...
  case "$month" in
  12|01|02)
    surf_coeffs=${pace_dir}sfc_tbl/viirs_surfcoeffs_2ndpfit_winter_20170809.hdf
    modis_surf_db=${pace_dir}sfc_tbl/aqua_modis_surfdb_winter_20110913.hdf
    viirs_surf_db=${pace_dir}sfc_tbl/viirs_surfdb_winter_20170327.hdf
    swir_vis_surf_coeffs=${pace_dir}sfc_tbl/viirs_snpp_swir_vs_vis_surf_coeffs_winter_all_2nd_minimum_20170809.hdf  

    ;;
  03|04|05)
    surf_coeffs=${pace_dir}sfc_tbl/viirs_surfcoeffs_2ndpfit_spring_20170809.hdf
    modis_surf_db=${pace_dir}sfc_tbl/aqua_modis_surfdb_spring_20110913.hdf
    viirs_surf_db=${pace_dir}sfc_tbl/viirs_surfdb_spring_20170327.hdf
    swir_vis_surf_coeffs=${pace_dir}sfc_tbl/viirs_snpp_swir_vs_vis_surf_coeffs_spring_all_2nd_minimum_20170809.hdf

    ;;
  06|07|08)
    surf_coeffs=${pace_dir}sfc_tbl/viirs_surfcoeffs_2ndpfit_summer_20170809.hdf
    modis_surf_db=${pace_dir}sfc_tbl/aqua_modis_surfdb_summer_20110913.hdf
    viirs_surf_db=${pace_dir}sfc_tbl/viirs_surfdb_summer_20170327.hdf
    swir_vis_surf_coeffs=${pace_dir}sfc_tbl/viirs_snpp_swir_vs_vis_surf_coeffs_summer_all_2nd_minimum_20170809.hdf

    ;;
  09|10|11)
    surf_coeffs=${pace_dir}sfc_tbl/viirs_surfcoeffs_2ndpfit_fall_20170809.hdf
    modis_surf_db=${pace_dir}sfc_tbl/aqua_modis_surfdb_fall_20110913.hdf
    viirs_surf_db=${pace_dir}sfc_tbl/viirs_surfdb_fall_20170327.hdf
    swir_vis_surf_coeffs=${pace_dir}sfc_tbl/viirs_snpp_swir_vs_vis_surf_coeffs_fall_all_2nd_minimum_20170809.hdf
...
#   config_file=`mktemp -p ../DB_DT_Land/DB_Land/tmp -t VIIRS_DB.XXXXXXXX`|| exit 1
  rm ${tmp_dir}/DB_PACE.config
  config_file=${tmp_dir}/DB_PACE.config
  cp ./DB_PACE_main.config ${config_file}
...
#   cat ../DB_DT_Land/DB_Land/supportMOD_PR04DB/config >> $config_file
  ...
  echo "pace_dir=$pace_dir" >> $config_file
