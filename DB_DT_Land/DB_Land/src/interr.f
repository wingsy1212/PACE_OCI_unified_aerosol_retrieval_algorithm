      subroutine interr(index1,index2,lprint,ezero,tr,sbx)
C-----------------------------------------------------------------------
C !F77
C
C !DESCRIPTION:
C
C    Calculates intensity terms used in computation of reflectivity.
...
c     -- debug print out
      ...
      return
 1000 format('Subroutine interr',/'Input:   index1 = ',i8,' index2 = ',
     1 i8)
