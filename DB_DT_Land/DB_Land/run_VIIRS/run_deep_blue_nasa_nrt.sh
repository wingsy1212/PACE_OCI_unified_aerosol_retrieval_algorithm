...
if [ $n_files -eq 0 ];
then
  echo No files found for ${l1a_dir}/VNP03MOD.${file_regex}*.nc.
  exit 1
fi
...
# $pre_anc_file and $post_anc_file.
  ...
  case "$geo_month" in
  12|01|02)
    surf_coeffs=${root_dir}/tbls/viirs_surfcoeffs_2ndpfit_winter_20170809.hdf
    modis_surf_db=${root_dir}/tbls/aqua_modis_surfdb_winter_20110913.hdf
    viirs_surf_db=${root_dir}/tbls/viirs_surfdb_winter_20170327.hdf
    swir_vis_surf_coeffs=${root_dir}/tbls/viirs_snpp_swir_vs_vis_surf_coeffs_winter_all_2nd_minimum_20170809.hdf  

    ;;
  03|04|05)
    surf_coeffs=${root_dir}/tbls/viirs_surfcoeffs_2ndpfit_spring_20170809.hdf
    modis_surf_db=${root_dir}/tbls/aqua_modis_surfdb_spring_20110913.hdf
    viirs_surf_db=${root_dir}/tbls/viirs_surfdb_spring_20170327.hdf
    swir_vis_surf_coeffs=${root_dir}/tbls/viirs_snpp_swir_vs_vis_surf_coeffs_spring_all_2nd_minimum_20170809.hdf

    ;;
  06|07|08)
    surf_coeffs=${root_dir}/tbls/viirs_surfcoeffs_2ndpfit_summer_20170809.hdf
    modis_surf_db=${root_dir}/tbls/aqua_modis_surfdb_summer_20110913.hdf
    viirs_surf_db=${root_dir}/tbls/viirs_surfdb_summer_20170327.hdf
    swir_vis_surf_coeffs=${root_dir}/tbls/viirs_snpp_swir_vs_vis_surf_coeffs_summer_all_2nd_minimum_20170809.hdf

    ;;
  09|10|11)
    surf_coeffs=${root_dir}/tbls/viirs_surfcoeffs_2ndpfit_fall_20170809.hdf
    modis_surf_db=${root_dir}/tbls/aqua_modis_surfdb_fall_20110913.hdf
    viirs_surf_db=${root_dir}/tbls/viirs_surfdb_fall_20170327.hdf
    swir_vis_surf_coeffs=${root_dir}/tbls/viirs_snpp_swir_vs_vis_surf_coeffs_fall_all_2nd_minimum_20170809.hdf
  ...
  *)
  ...
  l1b_file=`find -L ${l1a_dir} -maxdepth 1 -name "VNP02MOD.${geo_datetime}.*.nc"`
  echo ${geo_datetime}
  if [ -z $l1b_file ];
  then
    echo No NASA L1B file found: VNP02MOD.${geo_datetime}_*.nc
    continue
  fi
...
#   creation_dt=`date +%Y%m%d%H%M%S`  #calendar date
  ...
  output_file="AERDB_L2_VIIRS_SNPP.${geo_datetime}"
  output_file=$root_dir/l2_data/${output_file}'.'${collection}'.'${creation_dt}'.nrt.nc'
