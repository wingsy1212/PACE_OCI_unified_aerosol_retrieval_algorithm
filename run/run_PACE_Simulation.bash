...
input_dir=$Anc_package_path/L1_data
build_src=$PWD/build
run_dir=$PWD/run
OUT_DATA_HOME=$Anc_package_path/L2_data
write_dir=$PWD/Write_L2_data/pkg_root
dir_includ1=$PWD/DT_Common_src/inc
dir_includ2=$PWD/inc 
UTL_DIR=${PKG_HOME}/pkg_root 
RUNDIR=${run_dir} 
DBDIR=$Anc_package_path/DB_DT_Land/DB_Land/tbls/
...
# This section will create the Config_main_file before appending the inputfile to it.
echo "

output_dir = $Anc_package_path/L2_data/ 
! ANCILLARY DATASETS FROM PACE TEAM
landwater_mask = $Anc_package_path/ancillary/landmask_GMT15ARC.nc 

! UV-group LUTs
  uv_ai_mielut = $Anc_package_path/UV/tbls/LUT_TROPOMI_AI_MieCloud_v2_700hPa.h5
  uv_ai_lerlut = $Anc_package_path/UV/tbls/LUT_TROPOMI_AI_LER_v1.h5
uv_surfalbfile = $Anc_package_path/UV/tbls/OMIsurfalbPawan_v7.h5
uv_surfprsfile = $Anc_package_path/UV/tbls/TERRAIN_PRES.h5
uv_snowicefile = $Anc_package_path/UV/tbls/SNOW_ICE_CLIM.h5 
uv_ocncorr_lut = $Anc_package_path/UV/tbls/Fresnel_OceanLUT_v1.h5
    uv_aer_lut = $Anc_package_path/UV/tbls/LUT_v5_2wave.h5
   uv_sfc_file = $Anc_package_path/UV/tbls/sfctype_highRes.dat
  uv_zaer_file = $Anc_package_path/UV/tbls/Zaer_clm.dat
 uv_zaer2_file = $Anc_package_path/UV/tbls/Zaer_caliopclm.dat
uv_AIRSCO_clm_file = $Anc_package_path/UV/tbls/AIRSCO_clm_v4.dat
uv_omacalut_file = $Anc_package_path/UV/tbls/omacaLUT_v130.h5
uv_ssa388_clim_file = $Anc_package_path/UV/tbls/omaca_ssa388_v140.h5

! DT Tables Ocean
dt_ext_coeff = $Anc_package_path/DT_Ocean/tbls/VIIRS_LUT/Ocean_Ext_554_modislike
dt_gas_coeff = $Anc_package_path/DT_Ocean/tbls/VIIRS_LUT/VIIRS_GAS_COEFS_LBL_v1.dat
VIIRS_ocean  = $Anc_package_path/DT_Ocean/tbls/VIIRS_LUT/ 
Pace_ocean   = $Anc_package_path/DT_Ocean/tbls/PACE_LUT/  

! DT Tables Land
VIIRS_land  = $Anc_package_path/DB_DT_Land/DT_Land/tbls/VIIRS_LUT/

! DEEP-BLUE(s) LUTs
db_config = ./DB_PACE.config

! ML model
ml_model= $Anc_package_path/ML_UVAOD/data/
">OCIUAAER_Config_main
...
########################################################################
      ...
      ./db_config.sh -y $year -m $month -d $day -t $hh -i $mm -o $OUT_DATA_HOME  -p $DBDIR -s $Anc_Dir_GMAO
