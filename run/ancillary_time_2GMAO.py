...
aname0 = datetime.strftime(atime0,'GEOS.it.asm.asm_inst_1hr_glo_L576x361_slv.GEOS5294.%Y-%m-%dT%H%M.') 
aname1 = datetime.strftime(atime1,'GEOS.it.asm.asm_inst_1hr_glo_L576x361_slv.GEOS5294.%Y-%m-%dT%H%M.')
print (aname0)
print (aname1)
fname0 = glob(apath+datetime.strftime(atime0,'/%Y/%j/')+aname0+'*.nc4')[0]
fname1 = glob(apath+datetime.strftime(atime1,'/%Y/%j/')+aname1+'*.nc4')[0]
print (fname0)
print (fname1)
